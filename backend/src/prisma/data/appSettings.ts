...
const appSettingsData: AppSettingSeed[] = [
  ...
  },
  {
    ...
    description: "Default: every hour at :15. Re-processes recent Asia/Yangon days for late-arriving orders/sessions.",
  },
  {
    ...
    description: "How many Asia/Yangon calendar days (including today) to rebuild each aggregate tick.",
  },
  {
    key: "reporting_aggregate_backfill_days", value: "90", defaultValue: "90",
    valueType: "NUMBER", controlType: "NUMBER",
    category: "ops", sortOrder: 22, isPublic: false,
    labelEn: "Aggregate backfill window (days)", labelMy: "Aggregate backfill (ရက်)",
    description: "Scan this many recent days for missing or stale daily stats and rebuild a batch each tick.",
  },
  {
    key: "reporting_aggregate_backfill_batch", value: "14", defaultValue: "14",
    valueType: "NUMBER", controlType: "NUMBER",
    category: "ops", sortOrder: 22, isPublic: false,
    labelEn: "Aggregate backfill batch (days)", labelMy: "Aggregate backfill batch",
    description: "Max extra calendar days rebuilt per hourly tick after the lookback window.",
  },
  {
