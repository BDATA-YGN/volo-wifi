...
export class PrinterRoute implements Route {
  ...
  private initializeRoutes() {
     ...
     */
    this.router.get(`${this.path}/:id?`, AuthMiddleware, this.controller.printerListOrDetails);
     ...
     * @apiError (500) InternalServerError Unexpected server error.
     */
    this.router.post(`${this.path}/:id?`, AuthMiddleware, this.controller.printerCreateOrUpdate);
     ...
     * @apiError (500) InternalServerError Unexpected server error.
     */
    this.router.delete(`${this.path}/delete/:id`, AuthMiddleware, this.controller.printerDelete);
  }
}
