...
import { AccessVoucherRunsController } from './controller';

export class AccessVoucherRunsRoute implements Route {
  public path = '/wifi/access/voucher-runs';
  public router = Router();
  private controller = new AccessVoucherRunsController();
