...
import { CatalogServicePlansController } from './controller';

export class CatalogServicePlansRoute implements Route {
  public path = '/wifi/catalog/service-plans';
  public router = Router();
  private controller = new CatalogServicePlansController();
