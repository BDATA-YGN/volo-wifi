...
import { BillingSubscriptionController } from './controller';

export class BillingSubscriptionRoute implements Route {
  public path = '/wifi/billing/subscription';
  public router = Router();
  private controller = new BillingSubscriptionController();
