...
import { BillingSubscriptionSitesController } from './controller';

export class BillingSubscriptionSitesRoute implements Route {
  public path = '/wifi/billing/subscription/sites';
  public router = Router();
  private controller = new BillingSubscriptionSitesController();
