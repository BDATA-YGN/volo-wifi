...
import { CommerceCommissionsPayoutsController } from './controller';

export class CommerceCommissionsPayoutsRoute implements Route {
  public path = '/wifi/commerce/commissions/payouts';
  public router = Router();
  private controller = new CommerceCommissionsPayoutsController();
