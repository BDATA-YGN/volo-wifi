...
import { NetworkRadiusProfilesController } from './controller';

export class NetworkRadiusProfilesRoute implements Route {
  public path = '/wifi/network/radius/servers';
  public router = Router();
  private controller = new NetworkRadiusProfilesController();
