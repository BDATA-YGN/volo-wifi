...
import { AnalyticsLiveOpsController } from './controller';

export class AnalyticsLiveOpsRoute implements Route {
  public path = '/wifi/analytics/live-ops';
  public router = Router();
  private controller = new AnalyticsLiveOpsController();
