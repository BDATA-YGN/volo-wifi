...
import { AnalyticsSiteInventoryController } from './controller';

export class AnalyticsSiteInventoryRoute implements Route {
  public path = '/wifi/analytics/site-inventory';
  public router = Router();
  private controller = new AnalyticsSiteInventoryController();
