...
import { AnalyticsServicePlansController } from './controller';

export class AnalyticsServicePlansRoute implements Route {
  public path = '/wifi/analytics/service-plans';
  public router = Router();
  private controller = new AnalyticsServicePlansController();
