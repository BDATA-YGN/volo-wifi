...
import { AnalyticsAccessTokensController } from './controller';

export class AnalyticsAccessTokensRoute implements Route {
  public path = '/wifi/analytics/access-tokens';
  public router = Router();
  private controller = new AnalyticsAccessTokensController();
