...
export const PARTNER_NAV: PartnerNavItem[] = [
  ...
  { href: PARTNER_ROUTES.orders, label: "Orders", icon: "clipboard", match: "prefix" },
  { href: PARTNER_ROUTES.payments, label: "Payments", icon: "wallet", match: "prefix" },
...
export const PARTNER_SCREEN_TITLES: Record<string, string> = {
  ...
  [PARTNER_ROUTES.orders]: "Orders",
  [PARTNER_ROUTES.payments]: "Payments",
