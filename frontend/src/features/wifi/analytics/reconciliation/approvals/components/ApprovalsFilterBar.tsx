...
import type { PartnerOption, SiteOption, WorkflowStatus } from "../types";
...
type Props = {
  ...
  onStatusChange: (value: WorkflowStatus | undefined) => void;
};

const ApprovalsFilterBar: React.FC<Props> = ({
  stations,
  resellers,
  stationId,
  resellerId,
